config = {
            ...
            'branch': [
                ...
                {'name': 'ss_omega', 'sb': 'ss_rm', 'sp': 'UZ', 'c': '.ss', 'UZSTOP': {2: 20}, 'icp':['omega'], 'nmx': int(1e8)},
                {'name': 'lc_rm', 'sb': 'ss_rm', 'sp': 'HB', 'c': '.lc', 'icp':['rm', 11], 'UZSTOP': {1: 0.0, 1: 0.01}, 'nmx': int(1e9)},
                {'name': 'lc_omega', 'sb': 'lc_rm', 'sp': 'UZ', 'c': '.lc', 'icp':['omega', 11], 'UZSTOP': {2: 0.0, 1: 20, 11: 10000}, 'nmx': int(1e9)},
                ] 
        }
