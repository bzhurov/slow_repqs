config = {
            ...
            'branch': [
                {'name': 'ss_rm', 'sc': '.time', 'c': '.ss', 'icp': ['rm'], 'UZSTOP' : {1: 0.03}, 'n_start_repeat' : 200},
                {'name': '2p_hb0', 'sp': 'HB', 'sb': 'ss_rm', 'c': '.2p', 'icp': ['rm', 'omega'], 'nmx': 5000000},
                {'name': '2p_hb1', 'sp': 'HB', 'sb': 'ss_rm', 'c': '.2p', 'icp': ['rm', 'omega'], 'nmx': 5000000, 'DS': '-'},
                {'name': '2p_lp0', 'sp': 'LP1', 'sb': 'ss_rm', 'c': '.2p', 'icp': ['rm', 'omega'], 'nmx': 50000000},
                {'name': '2p_lp1', 'sp': 'LP1', 'sb': 'ss_rm', 'c': '.2p', 'icp': ['rm', 'omega'], 'nmx': 50000000, 'DS': '-'},
                {'name': '2p_lp2', 'sp': 'LP2', 'sb': 'ss_rm', 'c': '.2p', 'icp': ['rm', 'omega'], 'nmx': 50000000},
                {'name': '2p_lp3', 'sp': 'LP2', 'sb': 'ss_rm', 'c': '.2p', 'icp': ['rm', 'omega'], 'nmx': 50000000, 'DS': '-'}
                ] 
        }
