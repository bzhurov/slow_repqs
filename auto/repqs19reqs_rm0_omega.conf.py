config = {
            ...
            'branch': [
                {'name': 'ss_rm', 'sc': '.time', 'c': '.ss', 'icp': ['rm'], 'UZSTOP' : {1: 0.005}, 'n_start_repeat' : 200},
                {'name': 'ss_omega0', 'sp': 'UZ', 'sb': 'ss_rm', 'c': '.ss', 'icp': ['omega']},#, 'nmx': 5000000},
                ] 
        }
...
#         'eta': 0.0067, 'kua': 0.1, 'ka': 0.05, 'kRd': 0.034, 'kRud': 0.034, 'kRr': 0.000833, 'kRur': 1.6667, 'pR': 5
        ...
        'eta': 0.0067, 'kua': 0.16667, 'ka': 0.001667, 'kRd': 0.000833, 'kRud': 0.016667, 'kRr': 0.000833, 'kRur': 0.16667, 'pR': 1000
