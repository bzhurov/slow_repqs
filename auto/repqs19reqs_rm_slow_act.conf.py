config = {
            ...
            'branch': [
                {'name': 'ss_rm0', 'sc': '.time', 'c': '.ss', 'icp': ['rm'], 'UZSTOP' : {1: 1.0}, 'STOP': ['LP2'], 'n_start_repeat' : 200},
                {'name': 'ss_rm0', 'c': '.lc', 'sb': 'ss_rm0', 'sp': 'HB', 'icp': ['rm', 11], 'UZSTOP' : {1: 1.0}, 'nmx': 500000},
