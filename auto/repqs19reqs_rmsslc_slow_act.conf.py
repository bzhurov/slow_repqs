config = {
            ...
            'branch': [
                {'name': 'ss_rm', 'sc': '.time', 'c': '.ss', 'icp': ['rm'], 'UZSTOP' : {1: 0.0, 1: 0.03}, 'n_start_repeat' : 200, 'nmx': 99999999},
                {'name': 'lc_rm', 'sb': 'ss_rm', 'sp': 'HB', 'c': '.lc', 'icp':['rm', 11], 'nmx': 999999999},
                ] 
        }
