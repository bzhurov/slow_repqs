config = {
            ...
            'branch': [
                {'name': 'ss_rm0', 'sc': '.time', 'c': '.ss', 'icp': ['rm'], 'UZSTOP' : {1: 1.0}, 'STOP': ['LP1'], 'n_start_repeat' : 200},
                {'name': 'hb_1', 'sb': 'ss_rm0', 'sp': 'HB', 'c': '.2p', 'icp': ['rm', 'omega'], 'UZSTOP': {1: 0.0, 2: 0.0}},
                {'name': 'hb_2', 'sb': 'ss_rm0', 'sp': 'HB', 'c': '.2p', 'icp': ['rm', 'omega'], 'DS': '-', 'UZSTOP': {1: 0.0, 2: 0.0}},
                {'name': 'lp_1', 'sb': 'ss_rm0', 'sp': 'LP', 'c': '.2p', 'icp': ['rm', 'omega'], 'UZSTOP': {1: 0.0, 2: 0.0}},
                {'name': 'lp_2', 'sb': 'ss_rm0', 'sp': 'LP', 'c': '.2p', 'icp': ['rm', 'omega'], 'DS': '-', 'UZSTOP': {1: 0.0, 2: 0.0}},
                ] 
        }
...
#         'eta': 10, 'kua': 10, 'ka': 0.1, 'kRd': 0.05, 'kRud': 1, 'kRr': 0.05, 'kRur': 10, 'pR': 100
        ...
        'se': 0.0, 'omega': 60.0, 'rmI': 0.1,
        # 'rs': 0.0067, 'ds': 1.67e-5, 
        'rs': 0.00067, 'ds': 1.67e-5, 
